const DEFAULTS = { apiBase: "https://zoe-dispatch.fly.dev", intervalMin: 10, enabled: true, radarToken: "" };
...
document.getElementById("save").addEventListener("click", async () => {
  ...
  await chrome.storage.local.set({ apiBase, intervalMin, enabled, radarToken });
