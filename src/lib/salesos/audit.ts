...
export const SALES_ACTIONS: SalesAction[] = ["LEAD_VIEWED", "OUTREACH_DRAFTED", "MESSAGE_SENT", "LOSS_REASON_TAGGED", "BID_REVIEWED", "CALL_LOGGED", "CALL_DEBRIEF", "INBOUND_SMS", "BOARD_MOVE"];
