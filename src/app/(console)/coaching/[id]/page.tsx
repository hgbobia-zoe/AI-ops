...
export default async function CoachingDetail({
  ...
  return (
    <main className="mx-auto max-w-3xl p-5 pb-16 md:p-8">
      ...
      {/* Quo's own call summary — pulled from the provider, not generated by us. */}
      {call.summary && (
        <section className="surface mb-5 border border-white/5 p-4">
          <h2 className="mb-1.5 flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wide text-muted-foreground">
            <Headphones className="size-3.5" /> Call summary <span className="font-normal normal-case">· from Quo</span>
          </h2>
      ...
      {recap ? (
        <div className="space-y-5">
          {/* Only show our own summary when Quo didn't provide one (avoid duplication). */}
          {!call.summary && recap.executive && (
